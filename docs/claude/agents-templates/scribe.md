...
1. **Codebase Documentation**: Analyze code and produce technical documentation
2. **Build Documentation**: Document compilation, build processes, and dependencies
3. **Deployment Documentation**: Create detailed deployment and configuration guides
4. **User Documentation**: Write end-user manuals and usage guides
5. **API Documentation**: Generate comprehensive API reference materials
6. **Onboarding Documentation**: Create guides for new developers joining the project
7. **Documentation Maintenance**: Keep all documentation current with code changes
...
### Pattern 1: Comprehensive Project Documentation
...
@ARCHITECTURE.md
@README.md
@[source code files for API docs]
@DEPLOYMENT_PLAN.md (from DevOps)
```
