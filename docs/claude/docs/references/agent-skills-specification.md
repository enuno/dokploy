...
> **Source**: Official Agent Skills specification from [agentskills.io](https://agentskills.io)
> **Integrated**: 2025-12-21
> **License**: Open standard maintained by Anthropic

This document defines the Agent Skills format - an open standard for portable AI agent capabilities.
