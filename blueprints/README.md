...
| [ai-context](/blueprints/ai-context/) | Stateless markdown generator for LLM context with Cloudflare Access security and R2 integration | 1 (ai-context) | Ready |
...
| [multica](/blueprints/multica/) | Open-source managed AI coding agents platform with task boards, multi-agent workflows, and optional Cloudflare R2 storage | 3 (frontend, backend, postgres) | Ready |
...
| [paperclip](/blueprints/paperclip/) | AI agent orchestration platform — run a company of agents with org charts, budgets, goals, and governance | 2 (paperclip, postgres) | Ready |
